...
import { EmailDeliveryCommandSet } from './EmailDeliveryCommandSet';

export class EmailDeliveryController implements IConfigurable, IReferenceable, ICommandable, IOpenable, IEmailDeliveryController {
    ...
    private _commandSet: EmailDeliveryCommandSet;
    ...
    public getCommandSet(): CommandSet {
        if (this._commandSet == null)
            this._commandSet = new EmailDeliveryCommandSet(this);
