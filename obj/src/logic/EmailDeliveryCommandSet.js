...
class EmailDeliveryCommandSet extends pip_services_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeSendMessageToRecipientsCommand() {
        return new pip_services_commons_node_2.Command("send_message_to_recipients", new pip_services_commons_node_3.ObjectSchema(true)
            .withRequiredProperty('message', new EmailMessageV1Schema_1.EmailMessageV1Schema())
            .withRequiredProperty('recipients', new pip_services_commons_node_4.ArraySchema(new EmailRecipientV1Schema_1.EmailRecipientV1Schema()))
            .withOptionalProperty('parameters', pip_services_commons_node_5.TypeCode.Map), (correlationId, args, callback) => {
            let message = args.get("message");
...
exports.EmailDeliveryCommandSet = EmailDeliveryCommandSet;
//# sourceMappingURL=EmailDeliveryCommandSet.js.map