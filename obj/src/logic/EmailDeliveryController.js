...
const EmailDeliveryCommandSet_1 = require("./EmailDeliveryCommandSet");
class EmailDeliveryController {
    ...
    configure(config) {
        this._config = config.setDefaults(EmailDeliveryController._defaultConfig);
    ...
    getCommandSet() {
        if (this._commandSet == null)
            this._commandSet = new EmailDeliveryCommandSet_1.EmailDeliveryCommandSet(this);
...
EmailDeliveryController._defaultConfig = pip_services_commons_node_1.ConfigParams.fromTuples('message.from', null, 'message.cc', null, 'message.bcc', null, 'message.reply_to', null);
exports.EmailDeliveryController = EmailDeliveryController;
//# sourceMappingURL=EmailDeliveryController.js.map