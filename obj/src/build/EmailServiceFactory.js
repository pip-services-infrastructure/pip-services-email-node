...
class EmailServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
EmailServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-email", "factory", "default", "default", "1.0");
EmailServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-email", "controller", "default", "*", "1.0");
EmailServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-email", "service", "seneca", "*", "1.0");
EmailServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-email", "service", "http", "*", "1.0");
